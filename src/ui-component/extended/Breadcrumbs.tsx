                        ...
                        <Grid item>
                            ...
                            >
                                <Typography component={Link} to="/" color="textSecondary" variant="subtitle1" sx={linkSX}>
                                    ...
                                    {icon && !icons && <HomeIcon style={{ ...iconSX, marginRight: 0, color: 'primary.main' }} />}
    ...
    if ((item && item.type === 'item') || (item?.type === 'group' && item?.url) || custom) {
        ...
        let tempContent = (
            <MuiBreadcrumbs
                ...
                sx={{ '& .MuiBreadcrumbs-separator': { width: 16, ml: 1.25, mr: 1.25 } }}
            >
                <Typography component={Link} to={DASHBOARD_PATH} color="textSecondary" variant="subtitle1" sx={linkSX}>
                    {icons && <HomeTwoToneIcon style={iconSX} />}
