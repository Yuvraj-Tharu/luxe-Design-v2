...
const CareerLeadList = ({ entityName }: LeadListProps) => {
  ...
  const [singleInstanceFetched, setsingleInstanceFetched] = useState(false);
  ...
  const {
    ...
    headCells,
    singleInstanceState,
  } = useFormMetadata(url, entityName, singleInstanceFetched ? rows[0] : null);
