...
import CareerLeadList from './careerIndex';
import CareerBenefitsLeadList from './careerBenefits';
    ...
    return (
        <>
            <Stack direction="row" spacing={3}>
                <MuiLink href="#section1" color="#BD477A" underline="always">Section 1</MuiLink>
                <MuiLink href="#section2" color="#BD477A" underline="always">Section 2</MuiLink>
                <MuiLink href="#section3" color="#BD477A" underline="always">Section 3</MuiLink>
            </Stack>
            <MainCard title="Create Career Page Title">
                <Box sx={{ backgroundColor: '#eef2f6', borderRadius: 1, p: 2 }}>

                    <CareerLeadList entityName='career' />
                </Box>
                <Box sx={{ backgroundColor: '#eef2f6', borderRadius: 1, p: 2, mt: 2 }}>
                    <CareerLeadList entityName='career-benefit' />                </Box>
                <Box sx={{ backgroundColor: '#eef2f6', borderRadius: 1, p: 2, mt: 2 }} marginTop={2}>
                    <Typography variant="h4" sx={{ mb: 1 }}>
                        Manage other contents of this page
                    </Typography>
                    <Stack direction="row" spacing={4} flexWrap="wrap">
                        {links.map((link) => (
                            ...
                            >
                                <Typography variant="h5" sx={{ color: "#BD477A", textDecoration: "underline" }}>
                                    {link.label}
                                </Typography>
                            </Link>
                        ))}
